    ...
    <div className="max-w-7xl mx-auto px-4 py-8 w-full">
        ...
        <div className="bg-white/90 backdrop-blur rounded-3xl p-8 shadow-xl border border-slate-100 mb-12 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div 
                ...
                className={`flex items-center gap-4 bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-4 rounded-2xl shadow-lg hover:scale-105 transition-transform ${readOnly ? 'cursor-default' : 'cursor-pointer'}`}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <CategoryCard 
                ...
                stats={{ completed: 0, total: grammarStories.length }} // Placeholder, will be overridden by props if I change the interface
                onClick={() => onNavigate.toCategory('grammar')}
            ...
            <CategoryCard 
                ...
                onClick={() => onNavigate.toCategory('vocabulary')}
            ...
            <CategoryCard 
                ...
                onClick={() => onNavigate.toCategory('reading')}
            ...
            <CategoryCard 
                ...
                onClick={() => onNavigate.toCategory('listening')}
            ...
            <CategoryCard 
                ...
                onClick={() => onNavigate.toCategory('speaking')}
            ...
            <CategoryCard 
                ...
                onClick={() => onNavigate.toCategory('oral')}
            ...
            <CategoryCard 
                ...
                onClick={() => onNavigate.toCategory('writing')}
